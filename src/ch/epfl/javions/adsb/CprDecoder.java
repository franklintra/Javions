...
public class CprDecoder {
    ...
    public static GeoPos decodePosition(double x0, double y0, double x1, double y1, int mostRecent) {
        ...
        { // calculate latitude
            ...
            if (evenLat > 0.25) evenLat--; // if the latitude is greater than 90°, then it should be -90° + the latitude so one turn is subtracted
            if (oddLat > 0.25) oddLat--; // if the latitude is greater than 90°, then it should be -90° + the latitude so one turn is subtracted
        }
